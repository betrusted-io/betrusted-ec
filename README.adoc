...
The latest passing build register set documentation for the EC can be found at:
https://ci.betrusted.io/job/betrusted-ec-doc/lastSuccessfulBuild/artifact/build/documentation/_build/html/index.html
