...
Compiled documentation: https://ci.betrusted.io/job/betrusted-ec-doc/lastSuccessfulBuild/artifact/build/documentation/_build/html/index.html[latest register set], https://ci.betrusted.io/job/betrusted-ec-rustdoc/lastSuccessfulBuild/artifact/sw/betrusted-pac/target/riscv32i-unknown-none-elf/doc/betrusted_pac/index.html[latest rust API documentation]
...
1. Run `./betrusted-ec.py` (or `python3 ./betrusted-ec.py`)
