...
bindgen --no-derive-debug --ctypes-prefix c_types --use-core  imports/sl_status_bindgen.h -- -Iwfx_sys/wfx-fullMAC-driver/wfx_fmac_driver -Iwfx_sys/wfx-fullMAC-driver/wfx_fmac_driver/secure_links -Iwfx_sys/wfx-fullMAC-driver/wfx_fmac_driver/bus -Iwfx_sys/wfx-fullMAC-driver/wfx_fmac_driver/firmware --target=i386-pc-linux-gnu >> $BINDING_FILE

bindgen --no-derive-debug --ctypes-prefix c_types --use-core  imports/wfx.h -- -Iwfx_sys/wfx-fullMAC-driver/wfx_fmac_driver -Iwfx_sys/wfx-fullMAC-driver/wfx_fmac_driver/secure_links -Iwfx_sys/wfx-fullMAC-driver/wfx_fmac_driver/bus -Iwfx_sys/wfx-fullMAC-driver/wfx_fmac_driver/firmware --target=i386-pc-linux-gnu >> $BINDING_FILE
